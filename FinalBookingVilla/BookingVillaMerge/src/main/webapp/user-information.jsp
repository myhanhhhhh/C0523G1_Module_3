...
<head>
    ...
    <link rel="stylesheet" href="css_user/css/userInformation.css">
</head>
<body>
    ...
    <div class="main-body">
        ...
        <div class="row gutters-sm">
            <div class="col-md-4 mb-3">
                <div class="card boxshadow-outset">
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            <img src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="Admin"
                                 class="rounded-circle" width="150">
                            <div class="mt-3">
                                <h3 class="text-muted font-size-sm">${sessionScope.userName}</h3>
                            </div>
                        </div>
                    </div>
                </div>

                <div class="card mt-3 boxshadow-outset">
            ...
            <div class="col-md-8">
                <div class="card mb-3 boxshadow-outset">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-3">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <h6 class="mb-0">Số CCCD/CMND</h6>
                            </div>
                            <div class="col-sm-9 text-secondary content">
                                ${sessionScope.identityNumber}
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                        ...
                        <div class="d-flex btn-action">
                            <a class="btn btn-info content " href="/form-update-user.jsp">Sửa</a>
                            <a class="btn btn-info content" href="/change-password.jsp">Đổi mật khẩu</a>
                            <a  class="btn btn-danger content" data-bs-toggle="modal" data-bs-target="#exampleModal">Xóa</a>
                        </div>
                    </div>
                </div>
